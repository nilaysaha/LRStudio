...
export const DesktopSidebar: React.FC<DesktopSidebarProps> = ({
  ...
  if (isCollapsed) {
    return (
      <aside
        ...
        className="hidden md:flex flex-col items-center justify-between w-14 h-full bg-white/95 backdrop-blur-xl border-l border-[#E6E2D3] py-4 shadow-sm z-20 flex-shrink-0"
      >
        <div className="flex flex-col items-center gap-3">
          <button
            ...
            className="w-9 h-9 rounded-xl bg-[#FAF9F6] hover:bg-[#F0EEE6] border border-[#E6E2D3] flex items-center justify-center text-[#2A2723] hover:scale-105 active:scale-95 transition-all cursor-pointer shadow-xs"
        ...
        {/* Quick Vertical Icon Indicators */}
          ...
          {activeCollage ? (
            <>
              <button
                ...
                className="w-8 h-8 rounded-lg text-[#7E7365] hover:text-[#2A2723] flex items-center justify-center hover:bg-[#FAF9F6] transition-colors"
            ...
            ADJUSTMENT_TABS.slice(0, 4).map((t) => (
              <button
                key={t.id}
                type="button"
                onClick={() => {
  ...
  return (
    <aside
      ...
      className="hidden md:flex flex-col w-[360px] lg:w-[380px] h-full bg-white/95 backdrop-blur-xl border-l border-[#E6E2D3] shadow-md z-20 flex-shrink-0 overflow-hidden"
    >
      ...
      <div className="px-4 py-3 border-b border-[#F0EEE6] flex items-center justify-between flex-shrink-0 bg-[#FAF9F6]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-[#7E7365] hover:text-[#2A2723] hover:bg-[#EBE7DD] transition-colors cursor-pointer"
